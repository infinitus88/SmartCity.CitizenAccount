...
namespace SmartCity.CitizenAccount.Data.Access.Migrations
{
    ...
    [Migration("20211004071318_AddRegistrationDatePropertyToServiceEntity")]
    partial class AddRegistrationDatePropertyToServiceEntity
    {
            ...
            modelBuilder.Entity("SmartCity.CitizenAccount.Data.Models.Citizen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1B427852-ECC8-4BAB-9503-1821041F491D",
                            Balance = 0m,
                            ...
                            RegistrationDate = new DateTime(2021, 10, 4, 12, 13, 18, 223, DateTimeKind.Local).AddTicks(2300)
                        });
                });
            ...
            modelBuilder.Entity("SmartCity.CitizenAccount.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            IsVerified = false,
                            Password = "$2a$11$VozNZoTtM8oAxh6XCGuyIeJE/22OY72bkAFg/w8jVBSF8R0vqd4vG",
                            PhotoUrl = "data:image/jpeg;base64,",
                            Role = "admin",
                            Status = (byte)1
                        });
