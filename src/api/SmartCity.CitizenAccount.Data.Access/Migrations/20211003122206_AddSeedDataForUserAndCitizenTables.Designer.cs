...
namespace SmartCity.CitizenAccount.Data.Access.Migrations
{
    ...
    [Migration("20211003122206_AddSeedDataForUserAndCitizenTables")]
    partial class AddSeedDataForUserAndCitizenTables
    {
            ...
            modelBuilder.Entity("SmartCity.CitizenAccount.Data.Models.Citizen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "8114FC8D-6BEA-4009-9E7F-B5EA7C5B4F48",
                            Balance = 0m,
                            ...
                            RegistrationDate = new DateTime(2021, 10, 3, 17, 22, 6, 41, DateTimeKind.Local).AddTicks(7723)
                        });
                });
            ...
            modelBuilder.Entity("SmartCity.CitizenAccount.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            IsVerified = false,
                            Password = "$2a$11$tKEivPugPnlCSpnkqQBZdOzwfX0FHX8Ik7vodY3QBZXQy0suWuSru",
                            PhotoUrl = "data:image/jpeg;base64,",
                            Role = "admin",
                            Status = (byte)1
                        });
